...
const team = [
  ...
  {
    src: 'https://github.com/MindMakersProject/website-BE/blob/master/photos/MattJelmeni200x200.jpg?raw=true',
    name: 'Matt Jelmeni',
    role: 'Digital Strategist',
    type: 'Marketing',
    description: 'Matt is a brand consultant who specializes in online presence, web optimization, and social analytic trends. He has worked with several startups and numerous artists and entertainers. Many of his early networks and clients stem from the media and entertainment industries, which has contributed to the evolution of how he does business. The projects he is passionate about generally leverage social media, social media platforms, and original content to create trackable metrics and achieve goals. Matt supports Mind Makers because he enjoys helping hard working individuals to realize their potential through smart, sustainable, technologically sound business practices.'
  },
  {
  ...
  {
    src: 'https://github.com/MindMakersProject/website-BE/blob/master/photos/WillJohnson200x200.jpg?raw=true',
    name: 'Will Johnson',
    role: 'Software Engineer',
    type: 'Technical Leader',
    description: 'Will is a professional Software Engineer in the San Francisco area who specializes in data processing, analysis and visualization. He came to software engineering through writing macros in Microsoft excel when he realized the potential of programming and hasn\'t looked back since. He\'s excited about the Mind Makers Project\'s mission to inspire others to see and experience the endless possibilities of engineering and imagination.'
